...
namespace ICT272_Assignment_3_Online_Tourism_Platform.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(ICT272_Assignment_3_Online_Tourism_PlatformContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Password,Role")] User user)
        {
